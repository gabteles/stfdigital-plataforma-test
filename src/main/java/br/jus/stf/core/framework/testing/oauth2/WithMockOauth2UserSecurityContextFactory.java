...
final class WithMockOauth2UserSecurityContextFactory implements
	...
	public SecurityContext createSecurityContext(WithMockOauth2User withUser) {
		...
		Authentication authentication = Oauth2TestHelpers.buildOauth2TestAuthentication(username, withUser.pessoaId(), withUser.components(), grantedAuthorities.toArray(new GrantedAuthority[0]));
